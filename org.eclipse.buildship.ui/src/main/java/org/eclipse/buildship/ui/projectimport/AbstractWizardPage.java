...
public abstract class AbstractWizardPage extends WizardPage {
    ...
    private Composite createWizardPageContent(Composite parent) {
        ...
        // add placeholder text if the page defines it
        ...
        // set the root's content and return
    ...
    private void createWidgetsForContextInformation(Composite root, String contextInformation) {
        ...
        // 15 pixel margin not to stretch the contained separator widgets until the edge of the
        // wizard page
        ...
        // an internal container for flexible resize
        ...
        // a text widget aligned to the center having 400 pixels allocated for
