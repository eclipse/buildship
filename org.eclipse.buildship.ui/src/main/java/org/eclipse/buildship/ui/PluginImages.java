...
public enum PluginImages implements PluginImage {
    ...
    RERUN_FAILED_TESTS(ImmutableMap.of(ImageState.ENABLED, "icons/full/elcl16/rerun_failed_tests.gif", ImageState.DISABLED, "icons/full/dlcl16/rerun_failed_tests.gif")), // FIXME (donat) there is no HiDPI version of this icon in the platform
