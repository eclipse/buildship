    ...
    private static Ordering<ProjectNode> createProjectNodeOrdering() {
        return new Ordering<ProjectNode>() {
            ...
            public int compare(ProjectNode left, ProjectNode right) {
                EclipseProject leftRoot = CompatEclipseProject.getRoot(left.getEclipseProject());
                EclipseProject rightRoot = CompatEclipseProject.getRoot(right.getEclipseProject());
