...
public final class UiPluginConstants {
    ...
    /**
     * The context ID associated with projects, which have the Gradle project nature. This context
     * is activated when a selection in the workbench occurs, which is associated with an IProject,
     * which has the Gradle nature.
     */
    public static final String GRADLE_NATURE_CONTEXT_ID = "org.eclipse.buildship.ui.context.gradleNatureContext";
