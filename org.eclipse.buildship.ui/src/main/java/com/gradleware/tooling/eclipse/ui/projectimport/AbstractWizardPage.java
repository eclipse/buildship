...
import com.gradleware.tooling.eclipse.ui.HelpContext;
import com.gradleware.tooling.eclipse.ui.util.font.FontUtils;
import com.gradleware.tooling.eclipse.ui.util.widget.UiBuilder.UiBuilderFactory;
...
public abstract class AbstractWizardPage extends WizardPage {
    ...
    private final UiBuilderFactory builderFactory;
    ...
    protected AbstractWizardPage(String name, String title, String defaultMessage, ProjectImportConfiguration configuration, final List<Property<?>> observedProperties) {
        ...
        this.builderFactory = new UiBuilderFactory(this.defaultFont);
    ...
    protected UiBuilderFactory getUiBuilderFactory() {
