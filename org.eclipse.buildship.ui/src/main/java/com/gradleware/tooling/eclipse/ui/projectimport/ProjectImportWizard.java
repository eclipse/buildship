...
import com.gradleware.tooling.eclipse.ui.UiPlugin;
...
public final class ProjectImportWizard extends Wizard implements INewWizard {
     ...
     */
    private static final String IMPORT_DIALOG_SETTINGS = "com.gradleware.tooling.eclipse.ui.projectimport"; //$NON-NLS-1$
    ...
    /**
     * Creates a new instance and uses the {@link org.eclipse.jface.dialogs.DialogSettings} from {@link UiPlugin} and the
