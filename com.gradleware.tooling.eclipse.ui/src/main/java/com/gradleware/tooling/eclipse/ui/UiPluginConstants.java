...
public final class UiPluginConstants {
     ...
     * in focus.
     */
    public static final String UI_TASKVIEW_CONTEXT_ID = "com.gradleware.tooling.eclipse.ui.contexts.taskview";

    /**
     * The id of the command to refresh the task view.
     */
    public static final String REFRESH_TASKVIEW_COMMAND_ID = "com.gradleware.tooling.eclipse.ui.commands.refreshtaskview";

    /**
     * The id of the command to run the selected tasks.
     */
    public static final String RUN_TASKS_COMMAND_ID = "com.gradleware.tooling.eclipse.ui.commands.runtasks";

    /**
     * The id of the command to run the default tasks of the selected project.
     */
    public static final String RUN_DEFAULT_TASKS_COMMAND_ID = "com.gradleware.tooling.eclipse.ui.commands.rundefaulttasks";

    /**
     * The id of the command to open the run configuration for the selected tasks.
     */
    public static final String OPEN_RUN_CONFIGURATION_COMMAND_ID = "com.gradleware.tooling.eclipse.ui.commands.openrunconfiguration";
     ...
     */
    public static final String OPEN_BUILD_SCRIPT_COMMAND_ID = "com.gradleware.tooling.eclipse.ui.commands.openbuildscript";
