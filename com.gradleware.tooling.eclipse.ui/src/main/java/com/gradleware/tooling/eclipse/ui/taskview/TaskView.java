...
import com.gradleware.tooling.eclipse.ui.generic.QuickSearchManager;
import com.gradleware.tooling.eclipse.ui.generic.SelectionHistoryManager;
...
public final class TaskView extends ViewPart {
    ...
    public static final String ID = "com.gradleware.tooling.eclipse.ui.views.taskview"; //$NON-NLS-1$
