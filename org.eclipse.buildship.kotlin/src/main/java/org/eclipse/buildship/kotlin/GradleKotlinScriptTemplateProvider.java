...
public final class GradleKotlinScriptTemplateProvider implements ScriptTemplateProviderEx {
    ...
    public Map<String, Object> getEnvironment(IFile file) {
        ...
        BuildConfiguration projectConfig = CorePlugin.configurationManager().loadProjectConfiguration(file.getProject()).getBuildConfiguration();

        environment.put(GSK_PROJECT_ROOT, projectConfig.getRootProjectDirectory());
        environment.put(GSK_GRADLE_USER_HOME, workspaceConfig.getGradleUserHome());
        ...
        GradleDistributionWrapper gradleDistribution = GradleDistributionWrapper.from(projectConfig.getGradleDistribution());
