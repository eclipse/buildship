...
class GradleLaunchConfigurationManagerTest extends Specification {
    ...
    def validAttribute = GradleRunConfigurationAttributes.with( ['clean'], "/home/user/workspace/project", GradleDistributionWrapper.from(DistributionType.VERSION, "2.3").toGradleDistribution(), "/.java", ["-ea"], ["-q"], true, true)
    ...
    def "Run configurations are considered equal if working directory and tasks are equal"() {
        ...
        def atr =      GradleRunConfigurationAttributes.with( ['build'], "/home/user/workspace/project-p", GradleDistribution.forVersion('2.0'), null, [], [], false, false)
        def atrPrime = GradleRunConfigurationAttributes.with( ['build'], "/home/user/workspace/project-p", GradleDistribution.forVersion('2.1'), null, [], [], false, false)
