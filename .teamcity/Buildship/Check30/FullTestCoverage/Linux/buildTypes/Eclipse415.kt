...
object Eclipse415 : BuildType({
    id("Full_Test_Coverage_Linux_Eclipse415_Java8_30")
    name = "Full Test Coverage (Linux, Eclipse 2020-03, Java 8)"

    templates(EclipseBuildTemplate)

    params {
        param("eclipse.version", "415")
