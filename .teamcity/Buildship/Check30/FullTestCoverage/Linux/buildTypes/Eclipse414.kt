...
object Eclipse414 : BuildType({
    id("Full_Test_Coverage_Linux_Eclipse414_Java8_30")
    name = "Full Test Coverage (Linux, Eclipse 2019-12, Java 8)"

    templates(EclipseBuildTemplate)

    params {
        param("eclipse.version", "414")
