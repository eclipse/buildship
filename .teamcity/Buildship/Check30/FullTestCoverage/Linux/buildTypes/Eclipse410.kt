...
object Eclipse410 : BuildType({
    id("Full_Test_Coverage_Linux_Eclipse410_Java8_30")
    name = "Full Test Coverage (Linux, Eclipse 2018-12, Java 8)"

    templates(EclipseBuildTemplate)

    params {
        param("eclipse.version", "410")
