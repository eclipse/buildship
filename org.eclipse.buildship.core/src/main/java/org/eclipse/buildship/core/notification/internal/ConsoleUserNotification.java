...
public final class ConsoleUserNotification implements UserNotification {
    ...
    @Override
    public void errorOccurred(String message, String details, Throwable throwable) {
        System.err.println("User notification: message=[" + message + "], details=[" + details + "], exception=[" + throwable + "]");
    }
