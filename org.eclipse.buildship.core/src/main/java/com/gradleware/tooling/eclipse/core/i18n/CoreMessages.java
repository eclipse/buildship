...
package com.gradleware.tooling.eclipse.core.i18n;
...
public final class CoreMessages extends NLS {
    ...
    private static final String BUNDLE_NAME = "com.gradleware.tooling.eclipse.core.i18n.CoreMessages"; //$NON-NLS-1$
