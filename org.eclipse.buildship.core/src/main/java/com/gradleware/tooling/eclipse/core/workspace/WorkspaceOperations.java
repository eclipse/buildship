...
package com.gradleware.tooling.eclipse.core.workspace;
...
public interface WorkspaceOperations {
     ...
     * @throws com.gradleware.tooling.eclipse.core.GradlePluginsRuntimeException thrown if any of the deletions fails
     */
     ...
     * @throws com.gradleware.tooling.eclipse.core.GradlePluginsRuntimeException thrown if the project creation fails
     */
