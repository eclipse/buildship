...
abstract class ViewSpecification extends WorkspaceSpecification {
  ...
  private OmniEclipseProject newEclipseProject(ProjectNode parentNode, String path) {
    ...
    BuildConfiguration buildConfiguration = CorePlugin.configurationManager().createBuildConfiguration(projectDir, GradleDistribution.fromBuild(), false, false, false)
